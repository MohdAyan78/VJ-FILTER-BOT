...
API_ID = int(environ.get('API_ID', '20809916'))
API_HASH = environ.get('API_HASH', '9b5e6c6bfbf00afc3d78185880405988)
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6193633351').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001922584970').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fileshare:fileshare@cluster0.t6lnbki.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001920839571'))
